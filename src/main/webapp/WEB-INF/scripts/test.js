                ...
                for(var i = 0; i < result.friendsId.length; i++){  
                	...
                	if(groupDiv.length == 0 || groupDiv == null || groupDiv == undefined){
                	    $('#list_content_friend').append(
                	        '<div id="panel_'+result.friendsGroupNames[i]+'" class="panel panel-default"><div class="panel-heading"><h4 class="panel-title"><a href="#panel_group_'+result.friendsGroupNames[i]+'" data-toggle="collapse" data-parent="#list_content_friend">'+result.friendsGroupNames[i]+'</a><br></h4></div></div>');
